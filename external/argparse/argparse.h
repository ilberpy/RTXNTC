...
enum argparse_flag {
    ...
    ARGPARSE_USE_MESSAGE_BUFFER  = 1 << 2,
    ARGPARSE_NEVER_EXIT          = 1 << 3
};

enum argparse_result {
    ARGPARSE_OK = 0,
    ARGPARSE_UNKNOWN_ARGUMENT = -1,
    ARGPARSE_INVALID_VALUE = -2,
    ARGPARSE_HELP = -3
};
